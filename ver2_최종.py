...
class Ui_MainWindow(object):
    ...
    def filter_raman_peaks(self):
        ...
        # (무료) 출력할 범위 설정 (400~800)
        if 400 <= start_val <= 800 and 400 <= end_val <= 800:
            ...
            # 비밀번호 입력창 생성
            password, ok = QInputDialog.getText(self.tab_2, "Enter Password", "Please enter the password:", QLineEdit.Password)
            ...
            if ok and password == "1234":
                ...
                # 비밀번호 불일치 시 출력 메시지
                QtWidgets.QMessageBox.information(self.tab_2, "Paid Subscription Required", "유료가입대상입니다")
